...
from src.utils import (get_rows_by_column_value, get_years, make_urban_proportion_heatmap,plot_fires_vs_urban)
...
def main(
    csv_path: Path, countries: str, country_colm: str, year_colm: str, rural_colm: str, urban_colm: str, fires_colm: str
):
    ...
    for country in countries:
        country_df = pd.DataFrame(get_rows_by_column_value(
            file_path=csv_path,
            column_value=country,
            column_index=int(country_colm)
        ))
